...
&НаКлиенте
Процедура Расш1_АналитикаРасходовПоБазеНачалоВыбораПосле(Элемент, ДанныеВыбора, СтандартнаяОбработка)
		...
		Если ТипЗнч(ВыбранноеЗначение) = Тип("ФиксированныйМассив") Тогда
			...
			Для Каждого Значение ИЗ ВыбранноеЗначение Цикл
				...
				ИначеЕсли Расш1_ВТаблице Тогда
					СтрокаТаблицы = Элементы.Списание.ТекущиеДанные;
...
&НаКлиенте
Процедура Расш1_СписаниеАналитикаРасходовНачалоВыбораПосле(Элемент, ДанныеВыбора, СтандартнаяОбработка)
