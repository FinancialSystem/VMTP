&Вместо ("ПолучитьАналитикуРасходовПоУмолчанию") 
Функция Расш1_ПолучитьАналитикуРасходовПоУмолчанию(СтатьяРасходов, Объект) Экспорт
	...
	ИначеЕсли СтатьяРасходов.ТипЗначения = Новый ОписаниеТипов("СправочникСсылка.ПартииТМЦВЭксплуатации") Тогда
		АналитикаРасходов =  Справочники.ПартииТМЦВЭксплуатации.ПустаяСсылка();
